...
const CookieBanner = () => {
  ...
  return (
    <div
      ref={bannerRef}
      className="fixed bottom-[calc(env(safe-area-inset-bottom)+6rem)] left-4 right-4 md:bottom-6 md:left-auto md:right-6 md:max-w-md z-50 bg-white rounded-3xl shadow-2xl border border-gray-100 p-6 opacity-0 translate-y-24"
    >
